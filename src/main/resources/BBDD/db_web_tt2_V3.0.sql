...
--
-- Servidor: localhost
-- Tiempo de generación: 14-12-2010 a las 02:30:39
...
DROP TABLE IF EXISTS `contrincante_habilidad`;
...
DROP TABLE IF EXISTS `dialogo_mision`;
...
DROP TABLE IF EXISTS `dialogo_personaje`;
...
(13, 3, '2010-11-14 02:08:12', 1, NULL);
...
(5, 'Acuchillar', 'Daño físico moderado', -8, 3, 10, 'acuchillar', 2),
(6, 'Curación', 'Cura daño de forma instantánea', 12, 2, 11, 'curacion', 2),
(7, 'Envenenar', 'Lanza un veneno a tu oponente', -5, 4, 7, 'envenenar', 2),
(8, 'Aturdir', 'Daña físicamente e inhabilita al oponente', -5, 6, 4, 'aturdir', 2),
(9, 'Vendar', 'Cura daño mínimo', 4, 2, 6, 'vendar', 2),
(10, 'Zancadilla ', 'Golpe a las piernas del oponente', -6, 3, 9, 'zancadilla', 2),
(11, 'Maldecir', 'Lanza una maldición de daño al oponente', -7, 3, 8, 'maldecir', 2),
(12, 'Empujón', 'Aleja al oponente sin daño', 0, 2, 4, 'empujon', 2);
...
(13, 556, 216, 212, 204, 19, 23, 2399, 1105, 41250, 6312, '2010-11-30', 0, 1);
...
(3, 'Poción curadora', 'Esta poción revitaliza tus puntos de vida', 0, 23, 2, 3, 100, 'pocion'),
(4, 'Roca pesada', 'Roca pesada para tirarse de un puente', 2, 4900, 5000, 0, 0, 'roca'),
(5, 'Pescado', 'Alimento para curarse paultinamente', 0, 100, 1000, 0, 20, 'pescado'),
(6, 'Hongo', 'Vegetal que cura enfermedades simples', 0, 1, 5, 1, 15, 'hongo'),
(7, 'Amuleto de Koh', 'Muestra fehaciente de tu victoria ante Koh', 2, 15, 3000, 0, 0, 'amuleto'),
(8, 'Cincel', 'Artefacto para tallar', 1, 10, 100, 1, 50, 'cincel'),
(9, 'Martillo', 'Artefacto para golpear otras piezas', 1, 10, 250, 1, 50, 'martillo'),
(10, 'Pegamento rápido', 'Une dos piezas por medio de un lazo químico', 2, 25, 59, 0, 0, 'pegamento'),
(11, 'Casco de seguridad', 'Cuida tu cabeza frente a impactos', 1, 30, 900, 0, 0, 'casco');
...
DROP TABLE IF EXISTS `objeto_mision`;
...
(11, 'Sayón', 25, 2320, 1648, 3),
(12, 'Koh', 30, 2384, 1712, 3),
(13, 'Gerald', 53, 1968, 1568, 0);
...
(1, 'admin', 'admin', 'Gerald@hotmial.com', 'admin', 'sha1', 'a21af90656458ef0afbbdb43b5b990dc', '73d62e18e6d5a3525a5a283448bd96c7a0575d00', 1, 1, '2010-12-11 09:42:19', '2010-10-11 13:25:09', '2010-12-11 09:42:19'),
...
(11, 'Hola, ¿Cómo estás?'),
(12, 'Hola, debo juntar hongos, mientras mas ...¡Mejor! ...¿Te apuntas?'),
(13, 'Has vuelto, ¿Cómo te fue?'),
(14, 'Uff ...Has traído, pero no son suficientes, busca más'),

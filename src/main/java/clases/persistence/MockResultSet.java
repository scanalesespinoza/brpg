...
public class MockResultSet implements ResultSet {
    ...
    private Object getValue(String columnLabel) throws SQLException {
        ...
        // If not found, try to look for aliased columns or just return null/throw error
        // For now, return null but log?
        // System.out.println("Column not found: " + columnLabel);
        return null;
    }

    @Override
    public String getString(String columnLabel) throws SQLException {
        Object val = getValue(columnLabel);

...
public class Manager extends JGEngine {
     ...
     * Permite en una misma sesion de juego recuperar, actualizar y desconectar al
     * personaje Jugador.
     */
    private short idJugador = 18;// Valor en duro, debiera recibirse como parametro desde el sitio web
    private int interactuar = 0;// 0=Jugador presente en el juego/1=Jugador ausente e interactuando con Npc/>0
                                // Ejecutando dialogo y acciones de Npc
    private String nomNpcInteractuar;
    public int pausa = 0;// Modo de evitar que se ejecuten acciones por los 60 frames que ocurren por
                         // segundo
    ...
    private HashMap hsDatosPersonaje = new HashMap();// Mapa de datos utilizado para cargar un Jugador cuando su objeto
                                                     // no ha sido instanciado o fue removido
    ...
    public void initCanvas() {
        ...
        // Habilitar el escalado libre para que el juego aproveche la dimensión de la ventana del programa
        setScalingPreferences(0.0, 10.0, 0, 0, 0, 0);
    }
    ...
    public void initGame() {
        ...
        setAuthorMessage(
                "Sergio Canales Espinoza ||                    -JGame-                    || Gerald Schmidt Padilla");
        if (isApplet()) {
        ...
        try {
             ...
             * Canal : Evento --Sonidos de golpes, completar/tomar misiones, matar mobs,
             * subir de nivel
        ...
        double linea = 30;
        try {
            java.util.List<Habilidad> res = conect.getHabilidades();
            for (Habilidad habi : res) {
        ...
        boolean bool;
        try {
            java.util.List<Mision> resList = conect.getMisiones();
            for (Mision mis : resList) {
                mis.init(conect);
                mis.cargarDatos();
        ...
        try {
            ...
            while (res.next()) {
                switch (res.getShort("id")) {
                    ...
                    case 1:
                        npc_vendedor_1 = new Npc("vendedor_1", res.getShort("id"), res.getString("nombre"),
                                res.getShort("nivel"), res.getDouble("posicionx"), res.getDouble("posiciony"),
                                res.getShort("tipo"), conect);
                        break;
                    case 2:
                        npc_vendedor_2 = new Npc("vendedor_2", res.getShort("id"), res.getString("nombre"),
                                res.getShort("nivel"), res.getDouble("posicionx"), res.getDouble("posiciony"),
                                res.getShort("tipo"), conect);
                        break;
                    case 3:
                        npc_encargo_1 = new Npc("mision_1", res.getShort("id"), res.getString("nombre"),
                                res.getShort("nivel"), res.getDouble("posicionx"), res.getDouble("posiciony"),
                                res.getShort("tipo"), conect);
                        break;
                    case 4:
                        npc_encargo_2 = new Npc("mision_2", res.getShort("id"), res.getString("nombre"),
                                res.getShort("nivel"), res.getDouble("posicionx"), res.getDouble("posiciony"),
                                res.getShort("tipo"), conect);
                        break;
                    case 5:
                        npc_encargo_3 = new Npc("mision_3", res.getShort("id"), res.getString("nombre"),
                                res.getShort("nivel"), res.getDouble("posicionx"), res.getDouble("posiciony"),
                                res.getShort("tipo"), conect);
                        break;
                    case 13:
                        npc_encargo_4 = new Npc("guard_stand_r", res.getShort("id"), res.getString("nombre"),
                                res.getShort("nivel"), res.getDouble("posicionx"), res.getDouble("posiciony"),
                                res.getShort("tipo"), conect);
                        break;
                    case 14:
                        npc_encargo_5 = new Npc("guard_stand_r", res.getShort("id"), res.getString("nombre"),
                                res.getShort("nivel"), res.getDouble("posicionx"), res.getDouble("posiciony"),
                                res.getShort("tipo"), conect);
                        break;
                    case 15:
                        npc_encargo_6 = new Npc("viajero", res.getShort("id"), res.getString("nombre"),
                                res.getShort("nivel"), res.getDouble("posicionx"), res.getDouble("posiciony"),
                                res.getShort("tipo"), conect);
                        break;
                    case 16:
                        npc_encargo_7 = new Npc("mono", res.getShort("id"), res.getString("nombre"),
                                res.getShort("nivel"), res.getDouble("posicionx"), res.getDouble("posiciony"),
                                res.getShort("tipo"), conect);
                        break;
                    case 17:
                        npc_encargo_8 = new Npc("perdido", res.getShort("id"), res.getString("nombre"),
                                res.getShort("nivel"), res.getDouble("posicionx"), res.getDouble("posiciony"),
                                res.getShort("tipo"), conect);
                        break;
        ...
        try {
            ...
            while (res.next()) {
                switch (res.getShort("id")) {
                    // Pongo los constructores
                    case 6:
                        mob_facil_1 = new Mob("goblin_stand_r", "goblin_dying_l", 10, "goblin_hit_l", 5,
                                "goblin_attack_l", 13, "goblin_stand2_l", 11, 0.3, res.getShort("Id"),
                                res.getString("nombre"), res.getShort("nivel"), res.getShort("posicionx"),
                                res.getShort("posiciony"), res.getShort("tipo"), pj, false, 0.9,
                                res.getShort("vitalidad"), res.getShort("destreza"), res.getShort("sabiduria"),
                                res.getShort("fuerza"), res.getShort("experiencia"), res.getShort("dinero"), conect);
                        break;
                    case 7:
                        mob_facil_2 = new Mob("goblin2_stand_r", "goblin2_dying_l", 24, "goblin2_hit_l", 6,
                                "goblin2_attack_l", 13, "goblin2_stand2_l", 8, 0.3, res.getShort("Id"),
                                res.getString("nombre"), res.getShort("nivel"), res.getShort("posicionx"),
                                res.getShort("posiciony"), res.getShort("tipo"), pj, false, 0.9,
                                res.getShort("vitalidad"), res.getShort("destreza"), res.getShort("sabiduria"),
                                res.getShort("fuerza"), res.getShort("experiencia"), res.getShort("dinero"), conect);
                        break;
                    case 8:
                        mob_medio_1 = new Mob("tana_stand_r", "tana_dying_l", 20, "tana_hit_l", 5, "tana_attack_l", 11,
                                "tana_stand2_l", 6, 0.3, res.getShort("Id"), res.getString("nombre"),
                                res.getShort("nivel"), res.getShort("posicionx"), res.getShort("posiciony"),
                                res.getShort("tipo"), pj, false, 0.9, res.getShort("vitalidad"),
                                res.getShort("destreza"), res.getShort("sabiduria"), res.getShort("fuerza"),
                                res.getShort("experiencia"), res.getShort("dinero"), conect);
                        break;
                    case 9:
                        // mob_medio_2 = new Mob("mutant_stand_r","mutant_dying_l",60, "mutant_hit_l",
                        // 5, "mutant_attack_l", 18, "mutant_stand2_l", 8 ,0.3, res.getShort("Id"),
                        // res.getString("nombre"), res.getShort("nivel"), res.getShort("posicionx"),
                        // res.getShort("posiciony"), res.getShort("tipo"), pj, false, 0.9,
                        // res.getShort("vitalidad"), res.getShort("destreza"),
                        // res.getShort("sabiduria"), res.getShort("fuerza"),
                        // res.getShort("experiencia"), res.getShort("dinero"),conect);
                        break;
                    case 10:
                        // mob_dificil_1 = new Mob("grif_walk_l", "grif_dying_l",46, "grif_hit_l", 6,
                        // "grif_attack_l", 14, "grif_stand2_l", 8 , 0, res.getShort("Id"),
                        // res.getString("nombre"), res.getShort("nivel"), res.getShort("posicionx"),
                        // res.getShort("posiciony"), res.getShort("tipo"), pj, false, 0.9,
                        // res.getShort("vitalidad"), res.getShort("destreza"),
                        // res.getShort("sabiduria"), res.getShort("fuerza"),
                        ...
                        break;
                    case 11:
                        mob_dificil_2 = new Mob("wolverine", "wolverine_dying_l", 5, "wolverine_hit_l", 6,
                                "wolverine_attack_l", 7, "wolverine_stand2_l", 1, 0.0, res.getShort("Id"),
                                res.getString("nombre"), res.getShort("nivel"), res.getShort("posicionx"),
                                res.getShort("posiciony"), res.getShort("tipo"), pj, false, 0.9,
                                res.getShort("vitalidad"), res.getShort("destreza"), res.getShort("sabiduria"),
                                res.getShort("fuerza"), res.getShort("experiencia"), res.getShort("dinero"), conect);
                        break;
                    case 12:
                        mob_jefe_final = new Mob("boss_stand_l", "boss_dying_l", 20, "boss_hit_l", 5, "boss_attack_l",
                                14, "boss_stand2_l", 10, 0, res.getShort("Id"), res.getString("nombre"),
                                res.getShort("nivel"), res.getShort("posicionx"), res.getShort("posiciony"),
                                res.getShort("tipo"), pj, false, 0.9, res.getShort("vitalidad"),
                                res.getShort("destreza"), res.getShort("sabiduria"), res.getShort("fuerza"),
                                res.getShort("experiencia"), res.getShort("dinero"), conect);
        ...
        this.pj = new Jugador("human_", "pj_stand_r", 6, "pj_stand_r", 6, "pj_attack1_r", 3, "pj_stand_r", 6, 1,
                idJugador, conect);
        ...
        new JGTimer((int) (getFrameRate() * 10), false) {
            ...
            public void alarm() {
                if (!inGameState("InCombat")) {
                    ...
                    new StdScoring("scoring_pj_mp", (pj.x + 25) - viewXOfs(), (pj.y + 50) - viewYOfs(), -0.1, -0.005,
                            160, " +" + pj.regenerarMp(5) + " MP ", new JGFont("arial", 1, 11),
                            new JGColor[] { JGColor.blue }, 5, false);
                    pj.recibirDañoBeneficio((int) (pj.getHpMax() * 3 / 100) + 10);
                    new StdScoring("scoring_pj", (pj.x + 50) - viewXOfs(), (pj.y + 25) + 10 - viewYOfs(), -0.1, -0.005,
                            160, "" + (pj.getHpMax() * 3 / 100 + 10) + " HP", new JGFont("arial", 1, 13),
                            new JGColor[] { JGColor.green }, 5, false);
    ...
    public void doFrameInWorld() {
         ...
         * );
         */
        // llamada al metodo de colision entre objeto y escenario con las siguientes id
        // de colision
        checkBGCollision(
    ...
    public void paintFrameInDeath() {
        ...
        // new Ventana("Te encuentras exahusto despues del combate, vé a la ciudad para
        // recuperarte");
    }
    ...
    public void doFrameInDeath() {
        ...
        // personaje es enviado a la ciudad, poner con cara de muerto, o alguna seña que
        // lo está
    ...
    public void paintFrameInCombat() {
        ...
        drawRect(viewWidth() * 10 / 100 + viewXOfs(), 322 + viewYOfs() - 280,
                (float) (pj.getHp() * 100 / pj.getHpMax()), 10, true, false, 0, JGColor.green);
        drawRect(viewWidth() * 10 / 100 + viewXOfs(), 337 + viewYOfs() - 280,
                (float) (pj.getMp() * 100 / pj.getMpMax()), 10, true, false, 0, JGColor.blue);
        drawImage(((viewWidth() * 58) / 100), (double) 302 - 285, "monitor_hpmp", false);
        setColor(JGColor.white);
        drawString(mob_concurrente.getNombre() + " Nivel " + mob_concurrente.getNivel(), ((viewWidth() * 65) / 100),
                (double) 302 - 280, 0);
        drawRect(viewWidth() * 65 / 100 + viewXOfs(), 322 + viewYOfs() - 280,
                (float) (mob_concurrente.getHp() * 100 / mob_concurrente.getHpMax()), 10, true, false, 400,
                JGColor.green);
        drawRect(viewWidth() * 65 / 100 + viewXOfs(), 337 + viewYOfs() - 280,
                (float) (mob_concurrente.getMp() * 100 / mob_concurrente.getMpMax()), 10, true, false, 400,
                JGColor.blue);
        setTextOutline(0, null);
        setFont(new JGFont("Arial", 0, 10));
        drawString(pj.getHp() + "/" + pj.getHpMax(), ((viewWidth() * 17) / 100) + 9, 323 - 280, 0, false);
        drawString(mob_concurrente.getHp() + "/" + mob_concurrente.getHpMax(), ((viewWidth() * 72) / 100) + 9,
                323 - 280, 0, false);
        ...
        if (mob_concurrente.getIdProximoAtaque() != -1) {
            std_mob_habilidad = new StdScoring("nombreAtaque", ((viewWidth() * 70) / 100) + viewXOfs(),
                    315 + viewYOfs(), 0, 0, 80,
                    "Enemigo usó " + mob_concurrente.getHabilidades().getHabilidad(mob_concurrente.getIdProximoAtaque())
                            .getHabilidad().getNombre(),
                    new JGFont("Arial", 0, 12), new JGColor[] { JGColor.black, JGColor.white, JGColor.yellow }, 2);
        }
    }
    ...
    public void doFrameInCombat() {
        ...
        if (!terminar_combate) {
            // PESCO LOS ICONOS QUE FUERON PRESIONADOS POR EL JUGADOR Y LE DIGO AL OBJETO
            // JUGADOR
            // QUE ESA HABILIDAD SE VA A OCUPAR, LE ENTREGO COMO PARAMETRO LA HABILIDAD DEL
            // ICONO
            // PONER EN VARIABLES AL WEON CON CUAL EL QLIO DEL JUGADOR PELEA (nombre =
            // Enemigo)
            /************************** PERSONAJE **********************************/
            if (this.getIconoPresionado() != null && this.getIconoPresionado().getTipo() == 0) {
                ...
                if (pj.getIdProximoAtaque() != -1) {
                    std_pj_habilidad = new StdScoring("nombreAtaque2", ((viewWidth() * 16) / 100) + viewXOfs(),
                            315 + viewYOfs(), 0, 0, 80,
                            "Usaste " + pj.getHabilidades().getHabilidad(pj.getIdProximoAtaque()).getHabilidad()
                                    .getNombre(),
                            new JGFont("Arial", 0, 12), new JGColor[] { JGColor.black, JGColor.white, JGColor.yellow },
                            2);
                    ...
                    if (dañoBeneficio < 0) {
                        dañoBeneficio -= ((pj.getAtaque()) * (100 - mob_concurrente.getDefensa())) / 50
                                - pj.getAtaque();
                        // se convierte en daño hacia el enemigo
                        mob_concurrente.recibirDañoBeneficio(dañoBeneficio);
                        // si no es beneficio al jugador
                        std_mob_daño = new StdScoring("scoring_mob", ((viewWidth() * 78) / 100) + viewXOfs(),
                                (double) 302 + viewYOfs(), 0.09, -1, 160, "" + dañoBeneficio + " HP",
                                new JGFont("helvetica", 1, 20),
                                StdScoring.COLOR_DAMAGE, 5);
                        menu.playAudio("evento_combate", "golpe", false);
                        // menu.recibeScore(null, new StdScoring("scoring", mob_concurrente.x,
                        // mob_concurrente.y, 0, -2, 80, "" + dañoBeneficio, new JGFont("helvetica", 1,
                        // 20), new JGColor[]{JGColor.red, JGColor.orange, JGColor.yellow}, 5));
                    } else {
                        pj.recibirDañoBeneficio(dañoBeneficio);
                        menu.playAudio("evento_combate", "heal", false);
                        std_pj_sanacion = new StdScoring("scoring_pj", ((viewWidth() * 10) / 100) + viewXOfs(),
                                (double) 302 + viewYOfs(), -0.09, -1, 160, "" + dañoBeneficio + " HP",
                                new JGFont("helvetica", 1, 20), StdScoring.COLOR_HEAL, 5);
                        // menu.recibeScore(new StdScoring("scoring", pj.x, pj.y, 0, -2, 80, "" +
                        // dañoBeneficio, new JGFont("helvetica", 1, 20), new JGColor[]{JGColor.green,
                        // JGColor.yellow}, 5), null);
                    }
                ...
                // personaje ha utilizado algun tipo de objeto...validar que sea para uso en
                // combate
            ...
            if (mob_concurrente.getIdProximoAtaque() != -1) {
                ...
                if (dañoBeneficio < 0) {
                    dañoBeneficio += ((mob_concurrente.getAtaque()) * (-pj.getDefensa())) / 50
                            - (mob_concurrente.getAtaque() * mob_concurrente.getNivel()) / 4;
                    ...
                    std_pj_daño = new StdScoring("scoring_pj", ((viewWidth() * 10) / 100) + viewXOfs(),
                            (double) 302 + viewYOfs(), -0.09, -1, 160, "" + dañoBeneficio + " HP",
                            new JGFont("helvetica", 1, 20),
                            StdScoring.COLOR_DAMAGE, 5);
                    ...
                    mob_concurrente.recibirDañoBeneficio(dañoBeneficio);
                    std_mob_sanacion = new StdScoring("scoring_mob", ((viewWidth() * 78) / 100) + viewXOfs(),
                            (double) 302 + viewYOfs(), 0.09, -1, 160, "" + dañoBeneficio + " HP",
                            new JGFont("helvetica", 1, 20), StdScoring.COLOR_HEAL, 5);
                }
            }
            // regenero mana cada 4 segundos y que desaparezca cuando no esté en estado
            // INCOMBAT
            if (tiempoRegenerar == null || !tiempoRegenerar.running) {
                tiempoRegenerar = new JGTimer((int) (getFrameRate() * 4), false, "InCombat") {
                    ...
                    public void alarm() {
                        ...
                        std_pj_mana = new StdScoring("scoring_pj_mp", ((viewWidth() * 8) / 100) + viewXOfs(),
                                (double) 312 + viewYOfs(), -0.1, -0.5, 160, " +" + pj.regenerarMp(5) + " MP ",
                                new JGFont("helvetica", 1, 14), StdScoring.COLOR_MANA, 5);
                    }
                };
            }
        }
        ...
        if (mob_concurrente.getHp() <= 0) {
            ...
            if (menu.isTermineAnimacionMuerte()) {
                ...
                new StdScoring("pj_exp", pj.x, pj.y + 100, 0, -2, 120, mjs, new JGFont("helvetica", 1, 20),
                        new JGColor[] { JGColor.green }, 10);
                // menu.restablecerDinamicaCombate();
            }
        }
    }
    ...
    public void paintFrameInInteraction() {
        if (!salirInInteracting) {
            ...
            if (ventanaManager.terminoDialogo) {// genero el boton siguiente
                ...
                btn1.pintar();
            } else {// termino el dialogo //aun podria estar leyendo el ultimo parrafo = new
                    // Boton("cerrar", "suma", 430, 330, (int) (Math.pow(2, 5)), 0, 0);
    ...
    public void interacVentana(Jugador pj, Personaje vendedor, String estado) {
        ...
        if (cursor.getVentana() == 1) {
            ...
            // grillaNpc = new Boton("grilla npc", "grilla npc", viewXOfs() + 10, viewYOfs()
            // + 10, (int) Math.pow(2, 5));
            // grillaPj = new Boton("grilla pj", "grilla pj", viewXOfs() + 200, viewYOfs() +
            // 10, (int) Math.pow(2, 5));
            // ventanaTrade = new Boton("ventana trade", "ventana
            // trade",viewXOfs(),viewYOfs(),0);
    ...
    private void dibujarObjetosEscenario() throws SQLException {
        ...
        new Npc(352, 64, "arbol1", "arbol", (int) Math.pow(2, 6), 0, (short) 106, conect,
                new String[] { "Hola amiguirijillo", "soy Don Arbol, cuidame" });//
        new Npc(288, 32, "arbol2", "arbol", (int) Math.pow(2, 6), 0, (short) 107, conect,
                new String[] { "Hola amiguirijillo", "soy Don Arbol, cuidame" });//
        new Npc(128, 64, "arbol2", "pileta", (int) Math.pow(2, 6), 0, (short) 108, conect,
                new String[] { "Hola amiguirijillo", "soy la fuente magica" });//
        new Npc(16 * 100, 16 * 35, "arbol_seco1", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(16 * 140, 16 * 100, "arbol_seco2", "arbol_seco", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(16 * 130, 16 * 110, "arbol_seco3", "arbol_seco", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(16 * 60, 16 * 100, "arbol_seco4", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(80, 1616, "arbol_seco5", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        // new Npc(144, 1616, "arbol_seco6", "casa_5", (int) Math.pow(2, 6), (short) 4,
        // (short) 20, conect, new String[]{"escultura: "});
        new Npc(608, 1608, "arbol_seco7", "arbol_seco", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(880, 1184, "arbol_seco8", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(816, 1520, "arbol_seco9", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(752, 1136, "arbol_seco10", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(1072, 1408, "arbol_seco11", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(1168, 1248, "arbol_seco12", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(640, 960, "arbol_seco13", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(544, 960, "arbol_seco14", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(1564, 1232, "arbol_seco15", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(1632, 1040, "arbol_seco16", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(1840, 832, "arbol_seco17", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(2256, 848, "arbol_seco18", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(2352, 608, "arbol_seco19", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(2240, 336, "arbol_seco20", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(2016, 160, "arbol_seco21", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(1728, 160, "arbol_seco22", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        new Npc(1472, 96, "arbol_seco23", "arbol_seco2", (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                new String[] { "escultura: " });
        ...
        for (int i = 0; i < 100; i++) {
            ...
            new Npc(p, q, "rama" + i, "rama" + cont, (int) Math.pow(2, 6), (short) 4, (short) 20, conect,
                    new String[] { "escultura: " });
            cont++;
        }
    }
    ...
    public class Ventana {
        ...
        private StdScoring mensajito = new StdScoring("freak", 480, 380, 0, 0, -1, "", new JGFont("arial", 1, 10),
                new JGColor[] { JGColor.blue, JGColor.white }, 20, false);
        ...
        public void mostrarMensajeValidacion(String txt) {
            ...
            new StdScoring("validacion", 480 + viewXOfs(), 370 + viewYOfs(), 0, 0, 120, txt, new JGFont("arial", 1, 10),
                    new JGColor[] { JGColor.yellow, JGColor.black }, 20);
    ...
    public class Cursor extends JGObject {
        ...
        public void hit(JGObject obj) {
            if (obj instanceof Icono) {
                if (((Icono) obj).getTipo() == 0) {// habilidades{
                    ...
                    if (inGameState("InCommerce")) {
                        msj += " {pesa : " + objetos.get(((Icono) obj).getItem().getIdObjeto()).getPeso() + "| vale: "
                                + objetos.get(((Icono) obj).getItem().getIdObjeto()).getValorDinero() + "}";
                    }
            ...
            // click en NPC
            if (obj.colid == (int) Math.pow(2, 3) && obj.y < viewHeight() - 110 + viewYOfs()
                    && obj.x < viewXOfs() + viewWidth() - 110) {
                removerEquipo();
                        ...
                        if (getMouseButton(3)) {
                            ...
                            if (getXDist(npc_procesar.x, pj.x) <= 64 && getXDist(npc_procesar.y, pj.y) <= 30) {
                                ...
                                while (it.hasNext() && accion == 0) {
                                    ...
                                    Mision mis = npc_procesar.getMisiones().getMisiones()
                                            .get(Short.parseShort(e.getKey().toString())).getMision();
                                    if (!mis.isRepetible()) {// no es repetible
                                        if (!pj.getMisiones().isHizoMision(mis.getIdMision(),
                                                misiones.get(mis.getIdMision()))) {// nunca ha hecho la mision
                                            if (!pj.getMisiones().isHaciendoMision(mis.getIdMision())) {// no la esta
                                                                                                        // desarrollando
                                ...
                                switch (accion) {
                                    ...
                                    case 1: // el personaje no tiene la misión.. agregar
                                        ...
                                        ventanaManager.setDialogo(npc_concurrente.getMisiones().getMisiones()
                                                .get(mision_id).getMision().getDialogo().dialogoIniciarMision());
                                        break;
                                    case 2:// Comprobar Mision
                                        ...
                                        /** Iterator **/
                                        it = npc_procesar.getMisiones().getMisiones().get(mision_id).getMision()
                                                .getRequerimientos().getObjetos().entrySet().iterator();
                                        boolean fail = false;
                                        int cont = 0;
                                        while (it.hasNext() && !fail) {
                                            Map.Entry e = (Map.Entry) it.next();
                                            short objeto_id = Short.parseShort(e.getKey().toString());
                                            short cantidad = npc_procesar.getMisiones().getMisiones().get(mision_id)
                                                    .getMision().getRequerimientos().getObjetos().get(objeto_id)
                                                    .getCantidad();
                                        ...
                                        String stringRelleno = "...                                                      ...";// 30
                                                                                                                              // espacios

                                        if (fail) {// no tiene los requerimientos para cumplir la mision
                                            ventanaManager.setDialogo(npc_concurrente.getMisiones().getMisiones()
                                                    .get(mision_id).getMision().getDialogo().dialogoComprobarMision()
                                                    + stringRelleno
                                                    + npc_concurrente.getMisiones().getMisiones().get(mision_id)
                                                            .getMision().getDialogo().dialogoFalloMision());
                                        } else {
                                            // cumplio los requerimientos...
                                            Mision misi = npc_procesar.getMisiones().getMisiones().get(mision_id)
                                                    .getMision();
                                            int nivel = pj.getNivel();
                                            ...
                                            new StdScoring("pj_exp", pj.x, pj.y + 100, 0, -2, 120, mjs,
                                                    new JGFont("helvetica", 1, 20), new JGColor[] { JGColor.green },
                                                    10);

                                            interacVentana(npc_concurrente, "InInteraction");
                                            pj.getMisiones().completarMision(misi.getIdMision());
                                            // se da los item que tiene asociado el personaje que le dio la misión
                                            // (NPC_CONCURRENTE)
                                            ventanaManager.setDialogo(npc_concurrente.getMisiones().getMisiones()
                                                    .get(mision_id).getMision().getDialogo().dialogoComprobarMision()
                                                    + stringRelleno + stringRelleno
                                                    + npc_concurrente.getMisiones().getMisiones().get(mision_id)
                                                            .getMision().getDialogo().dialogoCumplirMision());
                                            ...
                                            for (Map.Entry id : misi.getRequerimientos().getObjetos().entrySet()) {
                                                ...
                                                short cantidad = misi.getRequerimientos().getObjetos().get(objeto_id)
                                                        .getCantidad();
            ...
            if (obj.colid == (int) Math.pow(2, 5)) {
                                    ...
                                    if (pj.getTotalPuntosHabilidad() > 0) {
                                        ...
                                        if (!pj.getHabilidades().tieneHabilidad((short) boton.getId())) {
                                            pj.getHabilidades().agregaHabilidad((short) boton.getId(),
                                                    habilidades.get((short) boton.getId()));
                                            pj.gastarPuntosHabilidad();

                                        } else if (pj.getHabilidades().getHabilidad((short) boton.getId())
                                                .puedeAumentar()) {
                        ...
                        switch (menu.getMenuActual()) {
                            case 4:// Menú está en Estadísticas
                                switch (boton.getId()) {
                                     ...
                                     */
                                    case 1:
                                        setInformacionEstadistica("Fuerza", "Aumenta el daño que causas",
                                                "La distribución de puntos no tiene restricción");
                                        break;//
                                    case 2:
                                        setInformacionEstadistica("Destreza", "Mejora tu precisión",
                                                "La distribución de puntos no tiene restricción");
                                        break;
                                    case 3:
                                        setInformacionEstadistica("Sabiduría", "Aumenta tu entereza espiritual",
                                                "La distribución de puntos no tiene restricción");
                                        break;
                                    case 4:
                                        setInformacionEstadistica("Vitalidad", "Aumenta los puntos de vida que posees",
                                                "La distribución de puntos no tiene restricción");
                                        break;
                                }
                                break;
                            case 1:// Menú está en Habilidad
                                ...
                                setInformacionHabilidad(hab.getNombre(), hab.getDescripcion(),
                                        String.valueOf(hab.getDanoBeneficio()), String.valueOf(hab.getCostoBasico()),
                                        String.valueOf(hab.getNivelMaximo()));
                                break;
                            case 2:// Menú está en misión
                                Mision mis = pj.getMisiones().getMisiones().get((short) boton.getId()).getMision();
                                setInformacionMision(mis.getNombre(), mis.getDescripcion(),
                                        String.valueOf(mis.getRecompensaExp()),
                                        String.valueOf(mis.getIdPersonajeConcluyeMision()));
                                break;
                        }
                ...
                if (obj.y >= viewYOfs() + (viewHeight() - 180)) {
                    ...
                    if (boton.getTipo_boton() == 3 && getMouseButton(3)) {
                        ...
                        setInformacionObjeto(item.getNombre(), item.getDescripcion(),
                                String.valueOf(item.getValorDinero()), String.valueOf(item.getTipo()),
                                String.valueOf(item.getPeso()), String.valueOf(item.isUsoCombate()));
                    }

                }

                if (obj.getName().equals("usable") && (getMouseButton(3) || getMouseButton(1))) {
                    seccion.removerIconos();
                    // cursor.setLimpiarIconos(true);
                    clearMouseButton(3);
                    clearMouseButton(1);
                ...
                } else if (obj.getName().equals("equipo") && (getMouseButton(3) || getMouseButton(1))) {
                    seccion.removerIconos();
                    // cursor.setLimpiarIconos(true);
                    clearMouseButton(3);
                    clearMouseButton(1);
                ...
                } else if (obj.getName().equals("colec") && (getMouseButton(3) || getMouseButton(1))) {
                    seccion.removerIconos();
                    // cursor.setLimpiarIconos(true);
                    clearMouseButton(3);
                    clearMouseButton(1);
            ...
            if (obj.colid == (int) Math.pow(2, 4)) {
                ...
                if (inGameState("InCommerce")) {
                    if ((getMouseButton(3) || getMouseButton(1)) && icon.belongTo(vendedor_concurrente.getTipo())) {
                        clearMouseButton(3);
                        clearMouseButton(1);
                        if (pj.validarDinero(icon.getItem().getValorDinero()) && pj.puedellevarItem(
                                icon.getItem().getIdObjeto(), (short) 1, objetos.get(icon.getItem().getIdObjeto()))) {
                            pj.getInventario().agregarItem(icon.getIdObjeto(),
                                    objetos.get(icon.getItem().getIdObjeto()));
                    ...
                    if ((getMouseButton(3) || getMouseButton(1)) && icon.belongTo(pj.getTipo())
                            && icon.getItem().getTipo() == filtro) {
                        clearMouseButton(3);
                        clearMouseButton(1);
                ...
                if (inGameState("InReward")) {
                    if ((getMouseButton(3) || getMouseButton(1)) && icon.belongTo(personaje_concurrente.getTipo())) {
                        clearMouseButton(3);
                        clearMouseButton(1);
                ...
                if (inGameState("InWorld")) {
                    if ((getMouseButton(3) || getMouseButton(1)) && ((Icono) obj).getTipo() == 1
                            && ((Icono) obj).getItem().getTipo() == 0) {
                        clearMouseButton(3);
                        clearMouseButton(1);
                        if (!pj.isBloquearUso()) {
                            ...
                            menu.playAudio("evento_combate", "heal2", false);
                            new StdScoring("scoring_pj", ((viewWidth() * 10) / 100) + viewXOfs(),
                                    (double) 302 + viewYOfs(), -0.09, -1, 160,
                                    "" + ((Icono) obj).getItem().getBeneficio() + " HP", new JGFont("helvetica", 1, 20),
                                    new JGColor[] { JGColor.green, JGColor.yellow }, 5);
        ...
        public void desplegarInformacion() {
            ...
            if (pjEntregar != null) {
                // drawString("A quién entregar : " + pjEntregar, viewWidth() / 2, viewHeight()
                // - 150, -1);
            }
            if (nota != null) {
        ...
        private void setInformacion(String nom, String desc, String val, String pes, String tip, String usoCom,
                String dano, String cos,
                    ...
                    case 0:
                        ...
                        while (this.tabla.y > 0) {
                            while (this.tabla.x > 0) {
                                if (it.hasNext()) {
                                    Map.Entry e = (Map.Entry) it.next();
                                    Habilidad hab = listHab.getHabilidad(Short.parseShort(e.getKey().toString()))
                                            .getHabilidad();
                                    cantidad++;
                                    hmIconoHabilidades.put(cantidad,
                                            new Icono("icono", this.recorrido.x, this.recorrido.y,
                                                    hab.getNombreGrafico(), hab.getIdHabilidad(), (short) 0,
                                                    listHab.getHabilidad(hab.getIdHabilidad()).getNivelHabilidad(),
                                                    personaje.getTipo(), hab.getNombre(), hab));
                                    if (inGameState("InReward")) {
                                    }
                                    this.recorrido.x += 37;
                                }
                                ...
                                if (it.hasNext()) {
                                    ...
                                    if (personaje.getTipo() == 0) {
                                        if (mostrarVestir == 1 && inGameState("InWorld")) {
                                            ...
                                            // again"+inv.getEquipo().get(obje.getIdObjeto()).getEquipado());
                                            if (obje.getTipo() == 1
                                                    && inv.getEquipo().get(obje.getIdObjeto()).getEquipado() == 1) {
                                                if (pj.getInventario().getEquipo().get(obje.getIdObjeto())
                                                        .getEquipaEn() == 1) {
                                                    equipo1 = new Icono("1icono", 115, 100, obje.getNombreGrafico(),
                                                            obje.getIdObjeto(), (short) 1,
                                                            inv.contarItem(obje.getIdObjeto()), personaje.getTipo(),
                                                            obje.getNombre(), obje);
                                                    // equipo1.suspend();
                                                } else if (pj.getInventario().getEquipo().get(obje.getIdObjeto())
                                                        .getEquipaEn() == 2) {
                                                    equipo2 = new Icono("2icono", 110, 170, obje.getNombreGrafico(),
                                                            obje.getIdObjeto(), (short) 1,
                                                            inv.contarItem(obje.getIdObjeto()), personaje.getTipo(),
                                                            obje.getNombre(), obje);
                                                    // equipo2.suspend();
                                                        ...
                                                        .getEquipaEn() == 3) {
                                                    equipo3 = new Icono("3icono", 70, 230, obje.getNombreGrafico(),
                                                            obje.getIdObjeto(), (short) 1,
                                                            inv.contarItem(obje.getIdObjeto()), personaje.getTipo(),
                                                            obje.getNombre(), obje);
                                                    // equipo3.suspend();
                                                        ...
                                                        .getEquipaEn() == 4) {
                                                    equipo4 = new Icono("4icono", 150, 230, obje.getNombreGrafico(),
                                                            obje.getIdObjeto(), (short) 1,
                                                            inv.contarItem(obje.getIdObjeto()), personaje.getTipo(),
                                                            obje.getNombre(), obje);
                                                    // equipo4.suspend();
                                                    ...
                                                    // new Icono("icono", this.recorrido.x, this.recorrido.y,
                                                    // obje.getNombreGrafico(), obje.getIdObjeto(), (short) 1,
                                                    // inv.contarItem(obje.getIdObjeto()), personaje.getTipo(),
                                                    // obje.getNombre(), obje);
                                                    equipo5 = new Icono("5icono", 110, 320, obje.getNombreGrafico(),
                                                            obje.getIdObjeto(), (short) 1,
                                                            inv.contarItem(obje.getIdObjeto()), personaje.getTipo(),
                                                            obje.getNombre(), obje);
                                                    // equipo5.suspend();
                                        ...
                                        if (obje.getTipo() == filtro) {
                                            ...
                                            // System.out.println("Nombre Objeto-----"+obje.getNombre()+"---lugar que se
                                            // equipa
                                            // "+pj.getInventario().getEquipo().get(obje.getIdObjeto()).getEquipaEn());
                                            // }
                                            // }
                                            if (inv.tieneItem(obje.getIdObjeto())) {
                                                hmIconoItem.put(cantidad,
                                                        new Icono("icono", this.recorrido.x, this.recorrido.y,
                                                                obje.getNombreGrafico(), obje.getIdObjeto(), (short) 1,
                                                                inv.contarItem(obje.getIdObjeto()), personaje.getTipo(),
                                                                obje.getNombre(), obje));
                                                setFont(new JGFont("Arial", 0, 24));
                                                // drawString("Cantidad" + inv.contarItem(obje.getIdObjeto()),
                                                // viewHeight() / 2, viewWidth() / 2, 0);
                                                this.recorrido.x += 37;
                                                this.tabla.x--;
                                            }
                                            // if(obje.getTipo()==1){
                                        ...
                                        if (inv.tieneItem(obje.getIdObjeto())) {
                                            System.out.println("Dibuje a este qlio 2: " + obje.getNombre() + " "
                                                    + obje.getNombreGrafico());
                                            hmIconoItem.put(cantidad,
                                                    new Icono("icono", this.recorrido.x, this.recorrido.y,
                                                            obje.getNombreGrafico(), obje.getIdObjeto(), (short) 1,
                                                            inv.contarItem(obje.getIdObjeto()), personaje.getTipo(),
                                                            obje.getNombre(), obje));
                                            setFont(new JGFont("Arial", 0, 24));
                                            // drawString("Cantidad" + inv.contarItem(obje.getIdObjeto()), viewHeight()
                                            // / 2, viewWidth() / 2, 0);
                                            this.recorrido.x += 37;
                                            this.tabla.x--;
                                        }

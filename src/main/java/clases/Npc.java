...
public class Npc extends Personaje {
    ...
    public Npc(double x, double y, String name, String mediaName, int colId, int tamano, short idNpc, dbDelegate conn,
            String[] dialogo) throws SQLException {
        ...
        setTileBBox(0, 0, 50, 50);
    }

    public Npc(double x, double y, String name, String mediaName, int tamano, short idNpc, short nivel, short tipo,
            dbDelegate conn, String[] dialogo) throws SQLException {
    ...
    public Npc(String graf, short idPersonaje, String nombre, short nivel, double posicionX, double posicionY,
            short tipo, dbDelegate conn) {
    ...
    @Override
    public void cargarDatos(HashMap<Short, Objeto> objetos, HashMap<Short, Habilidad> habilidades,
            HashMap<Short, Mision> misiones) {

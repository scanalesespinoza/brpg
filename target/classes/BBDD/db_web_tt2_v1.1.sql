...
--
-- Servidor: localhost
-- Tiempo de generación: 01-12-2010 a las 01:35:09
...
(1, 'El jardinero', 'Encuentra a Miguel en su hogar', 1, 30, 0, 4, 2),
(2, '¡Encontrar la cura!', 'He estado muy enfermo, y solo una medicina en el mundo me ayudará, por suerte...está en nuestra ciud', 1, 30, 0, 4, 3),
(3, 'Koh', 'Derrota a koh en lo más profundo del pantano', 30, 32000, 0, 4, NULL);
...
(1, 'admin', 'admin', 'Gerald@hotmial.com', 'admin', 'sha1', 'a21af90656458ef0afbbdb43b5b990dc', '73d62e18e6d5a3525a5a283448bd96c7a0575d00', 1, 1, '2010-12-01 01:28:17', '2010-10-11 13:25:09', '2010-12-01 01:28:17'),
...
(1, '¡Te estuve esperando!, Soy el alcalde de este humilde pueblo, han ocurrido cosas extrañas, habla con Miguel, en la casa de abajo'),
(2, 'Hola, soy Miguel, necesito que busques unos hongos, estos se encuentran en la humedad de las roca, husmea cerca de ellas'),
(3, '¿Ya hablaste con Miguel...el goloso? '),
(4, 'Veo que no, anda.. ¡Te servirá de mucha ayuda!'),
(5, 'Excelente, gracias por ayudarlo, ¿has quedado más claro?'),
(6, '¿Tienes lo que necesito?...'),
(7, 'No tienes lo que pido, rápido ve y tráemelos es urgente'),
(8, '¡Gracias!.. Con estos hongos mi herida sanará ');
